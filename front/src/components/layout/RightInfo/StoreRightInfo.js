...
const StoreRightInfo = ({data}) => {
    ...
    const [tabList, setTabList] = useState([
        {name : '리뷰', component : <ReviewTab id = {data.productInfo.id} list={data.productInfo.reviews}/>},
        {name : '문의', component : <ReviewTab id = {data.productInfo.id} list={data.productInfo.reviews}/>}
    ])
    ...
    checkOption();
    return (
        <RightInfoLayout title={"d"} tabList={tabList}>
                <PriceWrapper>
                    <ProductInfoTable>
                        <tr>
                            <th>
